...
public class DownloadSelectionActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_download_selection_sh);
        initData();
        initUI();
    }
    ...
    private void initData() {
        ...
        s3 = ShimmerUtilAWS.getS3Client(DownloadSelectionActivity.this);
        transferRecordMaps = new ArrayList<HashMap<String, Object>>();
    }

    private void initUI() {
        simpleAdapter = new SimpleAdapter(this, transferRecordMaps,
                R.layout.bucket_item_sh, new String[] {
                        "key"
                },
                new int[] {
                        R.id.key
    ...
    private class GetFileListTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... inputs) {
            ...
            s3ObjList = s3.listObjects(ConstantsAWS.BUCKET_NAME).getObjectSummaries();
