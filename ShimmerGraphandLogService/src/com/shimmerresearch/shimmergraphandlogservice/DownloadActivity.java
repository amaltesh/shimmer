...
public class DownloadActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.for_download);
        // Initializes TransferUtility, always do this before using it.
        transferUtility = ShimmerUtilAWS.getTransferUtility(this);
    ...
    private void initData() {
        ...
        for (TransferObserver observer : observers) {
            ...
            ShimmerUtilAWS.fillMap(map, observer, false);
    ...
    private void initUI() {
        ...
        simpleAdapter = new SimpleAdapter(this, transferRecordMaps,
                R.layout.record_item_sh, new String[] {
            ...
            public boolean setViewValue(View view, Object data,
                ...
                switch (view.getId()) {
                    ...
                    case R.id.textBytes:
                        ...
                        bytes.setTextColor(Color.parseColor("#000000"));
                        return true;
                    case R.id.textState:
    ...
    private void beginDownload(String key) {
        ...
        TransferObserver observer = transferUtility.download(ConstantsAWS.BUCKET_NAME, key, file);
        /*
    ...
    private void updateList() {
        ...
        for (int i = 0; i < observers.size(); i++) {
            ...
            ShimmerUtilAWS.fillMap(map, observer, i == checkedIndex);
        }
        simpleAdapter.notifyDataSetChanged();
    }
